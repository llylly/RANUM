class SpecifiedRanges:
    ...
    specified_ranges = {
        ...
        "ssd_mobile_net_v1": {
            "IteratorV2": [[0, None], [-1, 1], [None, None], [1, None], [None, None], [0, 299], [0, 1], [0, 1],
                           [None, None], [False, True], [0, 1], [1, 100]]},
        # HASH_KEY ; image pixels from [-1, 1]; unknown; real shape of image; unknown; the corner of boxes;
        # one hot values; one hot values; unknown; boolean value; weights; number of boxes
        "ssd_inception_v2": {
            "IteratorV2": [[0, None], [-1, 1], [None, None], [1, None], [None, None], [0, 299], [0, 1], [0, 1],
                           [None, None], [False, True], [0, 1], [1, 100]]},
        ...
        "learning_to_remember_rare_events": {"Placeholder": [-1, 1], "recent_idx": [0, None], "Placeholder_1": [0, 9],
                                             "memvals": [None, None]},
        # mnist pixel, index, mnist label; unknown
        "neural_gpu1": {"global_step": [1, None], "inp": [None, None], "length": [1, None], "tgt": [None, None],
                        "do_training": [0.1, 1]},
        # global training step; unknown inp, length, unknown tgt, dropout rate
        "neural_gpu2": {"global_step": [1, None], "inp": [None, None], "length": [1, None], "tgt": [None, None],
                        "do_training": [0.1, 1]},
        # the same reason above
        "ptn": {},
        # no input related
        ...
        "deep_contextual_bandits_bb_alpha_nn": {"data_size": [1, None], "w": [0, 1], "y": [None, None],
                                                "x": [None, None]},
        ...
        "adversarial_crypto": {},
        # no input related
        "sentiment_analysis": {"input_1": [0, None], "batch_normalization_v1/keras_learning_phase": [False, True],
                               "batch_normalization_v1/moving_variance": [0, None]},
        ...
        # image pixel
        "lfads": {"LFADS/keep_prob": [0.95, 1], "LFADS/data": [-1, 1],
                  "LFADS/z/ic_enc_2_post_g0/logvar/b": [-0.0625, 0.0625],
                  "LFADS/z/ic_enc_2_post_g0/logvar/W": [-0.0625, 0.0625]},
        ...
        # unknown
        "skip_thought": {
            "random_input_queue": [[0, None], [0, None], [0, None], [0, None], [0, None], [0, None], [0, None],
                                   [0, None], [0, None], [0, None], [0, None]], "beta2_power": [0.1, 0.9],
            "beta1_power": [0.1, 0.9]},
        # token_id & one hot values; optimizer beta powers; optimizer beta powers
        "video_prediction": {"model/Placeholder": [1, 10000],
                             "model/batch/fifo_queue": [[-1, 1], [None, None], [None, None]],
                             "val_model/Placeholder": [1, 10000],
                             "val_model/batch/fifo_queue": [[-1, 1], [None, None], [None, None]]},
        ...
        "domain_adaptation": {"batch_1/fifo_queue": [[-1, 1], [None, None]],
                              "batch/fifo_queue": [[-1, 1], [None, None]]},
