...
def train_input_gen(modelpath, err_node_name, err_seq_no, checkpoint_folder, seed, learning_rate=1., max_iter=300):
    """
    ...
    if not has_diff:
        ...
        if not has_diff:
            ...
            for iters in range(max_iter):
                ...
                # if not success:
                num_errors, errors = traingen_module.check(learning_rate=learning_rate)
